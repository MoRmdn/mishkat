// One entry per file in assets/icons/*.svg (24×24, 1.5 stroke, currentColor),
// from the 2a design handoff. Every icon in the app comes through here.
import 'package:flutter/widgets.dart';
import 'package:flutter_svg/flutter_svg.dart';

enum MIcon {
  account('account', directional: false),
  ...
  cloudCheck('cloud-check', directional: false),
  cloudOff('cloud-off', directional: false),
  cloudSync('cloud-sync', directional: false),
